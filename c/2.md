...
如果未安装 GCC，那么您必须按照 [http://gcc.gnu.org/install/](//gcc.gnu.org/install/) 上的详细说明安装 GCC。
...
为了在 Windows 上安装 GCC，您需要安装 MinGW。为了安装 MinGW，请访问 MinGW 的主页 [www.mingw.org](//www.mingw.org/)，进入 MinGW 下载页面，下载最新版本的 MinGW 安装程序，命名格式为 MinGW-&lt;version&gt;.exe。
